...
def banner():
    ...
    print(bcolors.GREEN + '+[+[+[ made by karan bisht ]+]+]+')
    print(bcolors.GREEN + '''
                     \|/
                       `--+--'
                          |
...
*.______________________________________________________________,' (Bomb)
                                                                    `--' ''')
    print(bcolors.GREEN + """|  \/  |                     | |                      | |                
 | \  / |  ___   __ _   __ _  | |__    ___   _ __ ___  | |__    ___  _ __ 
 | |\/| | / _ \ / _` | / _` | | '_ \  / _ \ | '_ ` _ \ | '_ \  / _ \| '__|
 | |  | ||  __/| (_| || (_| | | |_) || (_) || | | | | || |_) ||  __/| |   
 |_|  |_| \___| \__, | \__,_| |_.__/  \___/ |_| |_| |_||_.__/  \___||_|   
                 __/ |                                                    
                |___/                                         """)
    print(bcolors.RED +""" _   __  ___  ______   ___   _   _  __   __ _    _ 
| | / / / _ \ | ___ \ / _ \ | \ | | \ \ / /| |  | |
| |/ / / /_\ \| |_/ // /_\ \|  \| |  \ V / | |  | |
|    \ |  _  ||    / |  _  || . ` |  /   \ | |/\| |
| |\  \| | | || |\ \ | | | || |\  | / /^\ \\  /\  /
